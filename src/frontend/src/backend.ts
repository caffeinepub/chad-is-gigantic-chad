...
export class Backend implements backendInterface {
    ...
    async getAvailableGames(): Promise<Array<Game>> {
    ...
    async getHighScores(arg0: string): Promise<Array<Score>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHighScores(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayerScore(arg0: string, arg1: string): Promise<bigint | null> {
        if (this.processError) {
            try {
